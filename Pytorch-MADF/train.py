...
# training options
parser.add_argument('--train_root', type=str, default='train_data/dataset1_2')
parser.add_argument('--test_root', type=str, default='train_data/test1_2')
parser.add_argument('--mask_root', type=str, default='train_data/mask')
...
parser.add_argument('--batch_size', type=int, default=6) #6
parser.add_argument('--n_threads', type=int, default=16) # 16
...
parser.add_argument('--load_size', type=int, default=316)
